...
export type PlaceDetailsScreenProps = NavigationScreenProps<
  PlaceDetailsScreenNavigationParams
>;
...
export const PlaceDetailsScreen: FunctionComponent<PlaceDetailsScreenProps> = ({
  ...
  const place = useSelector((state: ApplicationState) =>
    state.places.places.find((p) => p.key === placeId)
  );
